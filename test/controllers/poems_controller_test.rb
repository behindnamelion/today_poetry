...
class PoemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poem" do
    assert_difference('Poem.count') do
      post poems_url, params: { poem: { body: @poem.body, description: @poem.description, title: @poem.title, year: @poem.year } }
    end
  ...
  test "should update poem" do
    patch poem_url(@poem), params: { poem: { body: @poem.body, description: @poem.description, title: @poem.title, year: @poem.year } }
