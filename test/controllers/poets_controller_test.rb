...
class PoetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poet" do
    assert_difference('Poet.count') do
      post poets_url, params: { poet: { birthplace: @poet.birthplace, birthyear: @poet.birthyear, description: @poet.description, name: @poet.name } }
    end
  ...
  test "should update poet" do
    patch poet_url(@poet), params: { poet: { birthplace: @poet.birthplace, birthyear: @poet.birthyear, description: @poet.description, name: @poet.name } }
